...
var treeMenu = [
  ...
  //  { level:2, name:"学生列表", ico:"images/icon_default.gif",link:"index.jsp"},
	...
	{ level:1, name:"网盘管理"},
	{ level:2, name:"文件上传", ico:"images/icon_default.gif",link:"upload.jsp"},
	{ level:2, name:"文件下载", ico:"images/icon_default.gif",link:""},
	{ level:1, name:"相册管理", ico:"images/icon_default.gif"},
